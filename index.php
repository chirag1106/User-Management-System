                    ...
                    <div class="col-lg-7 bg-white p-4" style="flex-grew:1.4;">
                        ...
                        <form action="#" method="post" class="px-3" id="register-form">
                            ...
                            <div class="input-group input-group-lg form-group">
                                ...
                                <input type="text" id="name" name="name" class="form-control rounded-0" placeholder="Full Name" autocomplete="off" required />
                            </div>
                            <div class="input-group input-group-lg form-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text rounded-0"><i class="far fa-envelope fa-lg fa-fw"></i></span>
                                </div>
                                <input type="email" id="remail" name="email" class="form-control rounded-0" placeholder="E-Mail" autocomplete="off" required />
                            </div>
                            <div class="input-group input-group-lg form-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text rounded-0"><i class="fas fa-key fa-lg fa-fw"></i></span>
                    ...
                    <div class="col-lg-7 bg-white p-4">
                        ...
                        <div id="forgotAlert"></div>
                            <div class="input-group input-group-lg form-group">
                                ...
                                <input type="email" id="femail" name="email" class="form-control rounded-0" placeholder="E-Mail" autocomplete="off" required />
                            </div>
                            <div class="form-group">
